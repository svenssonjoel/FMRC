...
$EndComp
$Comp
L robot_pcb0-rescue:C-device-vesc_hp_v1-rescue-uwb_pcb-rescue C3
U 1 1 5A4BDE38
P 6250 1100
...
$EndComp
$Comp
L robot_pcb0-rescue:C-device-vesc_hp_v1-rescue-uwb_pcb-rescue C12
U 1 1 5A4BDE39
P 7000 1100
...
$EndComp
$Comp
L robot_pcb0-rescue:C-device-vesc_hp_v1-rescue-uwb_pcb-rescue C10
U 1 1 5A4BDE3C
P 6850 2300
...
$EndComp
$Comp
L robot_pcb0-rescue:C-device-vesc_hp_v1-rescue-uwb_pcb-rescue C7
U 1 1 5A4BDE40
P 6550 4750
...
$EndComp
$Comp
L robot_pcb0-rescue:C-device-vesc_hp_v1-rescue-uwb_pcb-rescue C4
U 1 1 5A4BDE42
P 6350 5350
...
$EndComp
$Comp
L robot_pcb0-rescue:C-device-vesc_hp_v1-rescue-uwb_pcb-rescue C5
U 1 1 5A4BDE43
P 6350 5600
...
$EndComp
$Comp
L robot_pcb0-rescue:C-device-vesc_hp_v1-rescue-uwb_pcb-rescue C6
U 1 1 5A4BDE45
P 6400 3650
...
$EndComp
$Comp
L robot_pcb0-rescue:C-device-vesc_hp_v1-rescue-uwb_pcb-rescue C8
U 1 1 5A4BDE46
P 6650 3650
...
$EndComp
$Comp
L robot_pcb0-rescue:C-device-vesc_hp_v1-rescue-uwb_pcb-rescue C11
U 1 1 5A4BDE47
P 6900 3650
...
$EndComp
$Comp
L robot_pcb0-rescue:C-device-vesc_hp_v1-rescue-uwb_pcb-rescue C13
U 1 1 5A4BDE48
P 7150 3650
...
$EndComp
$Comp
L robot_pcb0-rescue:Crystal_GND24-device-vesc_hp_v1-rescue-uwb_pcb-rescue Y1
U 1 1 5A4C0BA1
P 6650 1300
...
Wire Wire Line
	6800 4900 6800 5000
$Comp
L robot_pcb0-rescue:C-device-vesc_hp_v1-rescue-uwb_pcb-rescue C9
U 1 1 5A4BDE41
P 6800 4750
...
CAN_RX
Text GLabel 3400 3000 0    60   Output ~ 0
CAN_TX
...
SWCLK
$Comp
L robot_pcb0-rescue:CONN_01X06-RESCUE-RCCAR_IF_Board_GPS-RCCAR_IF_Board_GPS-rescue-uwb_pcb-rescue P1
U 1 1 56C07D77
P 10800 1150
...
Wire Wire Line
	4450 7200 4550 7200
$Comp
L robot_pcb0-rescue:C-RESCUE-RCCAR_IF_Board_GPS-RCCAR_IF_Board_GPS-rescue-uwb_pcb-rescue C1
U 1 1 5AF962C0
P 5850 6700
...
$EndComp
$Comp
L robot_pcb0-rescue:C-RESCUE-RCCAR_IF_Board_GPS-RCCAR_IF_Board_GPS-rescue-uwb_pcb-rescue C2
U 1 1 5AF9636C
P 6150 6700
...
Wire Wire Line
	5150 6500 5300 6500
$Comp
L robot_pcb0-rescue:MPU9250-crf_1 U3
U 1 1 5B08F0D3
P 8850 3450
F 0 "U3" H 8850 4437 60  0000 C CNN
...
$EndComp
$Comp
L robot_pcb0-rescue:C-device-vesc_hp_v1-rescue-uwb_pcb-rescue C14
U 1 1 5B090107
P 9500 3750
...
$EndComp
$Comp
L robot_pcb0-rescue:C-device-vesc_hp_v1-rescue-uwb_pcb-rescue C15
U 1 1 5B09F49D
P 9750 3750
F 0 "C15" H 9775 3850 50  0000 L CNN
...
$EndComp
$Comp
L robot_pcb0-rescue:C-device-vesc_hp_v1-rescue-uwb_pcb-rescue C16
U 1 1 5B09F850
P 10000 3750
F 0 "C16" H 10025 3850 50  0000 L CNN
...
U 1 1 5B165B83
P 9750 2600
F 0 "#PWR022" H 9750 2700 30  0001 C CNN
...
U 1 1 5B187447
P 8050 4300
F 0 "#PWR019" H 8050 4050 50  0001 C CNN
...
U 1 1 5B19831C
P 7900 3800
F 0 "#PWR018" H 7900 3900 30  0001 C CNN
...
U 1 1 5B2A024D
P 8650 4750
F 0 "R5" V 8550 4650 50  0000 C CNN
...
U 1 1 5B2A0461
P 9000 4600
F 0 "#PWR020" H 9000 4700 30  0001 C CNN
F 1 "VCC" H 9000 4700 30  0000 C CNN
...
SDA
Text GLabel 8100 4950 0    50   Output ~ 0
SCL
Text GLabel 8100 4850 0    50   Output ~ 0
SDA
NoConn ~ 3400 2600
Wire Wire Line
	3400 4400 3200 4400
...
F 1 "UART" H 10827 4835 50  0000 L CNN
...
U 1 1 5B0B198A
P 8800 900
F 0 "J10" V 8965 830 50  0000 C CNN
F 1 "GPIO" V 8874 830 50  0000 C CNN
F 2 "Connector_JST:JST_PH_B8B-PH-K_1x08_P2.00mm_Vertical" H 8800 900 50  0001 C CNN
...
GPIO0
Text GLabel 8600 1100 3    50   Input ~ 0
GPIO1
Text GLabel 8700 1100 3    50   Input ~ 0
GPIO2
Text GLabel 8800 1100 3    50   Input ~ 0
GPIO3
Text GLabel 8900 1100 3    50   Input ~ 0
GPIO4
Text GLabel 9000 1100 3    50   Input ~ 0
GPIO5
